...
static void __Template_SiderCreate(lv_obj_t* parent);
static void __Template_TopInfoCreate(lv_obj_t* parent);
static void __Template_ContentCreate(lv_obj_t* parent);
static void __Template_BottomInfoCreate(lv_obj_t* parent);


void __Template_Create(lv_obj_t* parent)
{
    __Template_BottomInfoCreate(parent);
    __Template_ContentCreate(parent);
    __Template_TopInfoCreate(parent);
