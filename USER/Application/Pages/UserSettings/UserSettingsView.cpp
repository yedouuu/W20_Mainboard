...
static void UserSettings_SiderCreate(lv_obj_t* parent);
static void UserSettings_TopInfoCreate(lv_obj_t* parent);
static void UserSettings_ContentCreate(lv_obj_t* parent);
static void UserSettings_BottomInfoCreate(lv_obj_t* parent);
static void settings_btn_event_cb(lv_event_t* e);

void UserSettings_Create(lv_obj_t* parent)
{
    UserSettings_BottomInfoCreate(parent);
    UserSettings_ContentCreate(parent);
    UserSettings_TopInfoCreate(parent);
...
static void settings_btn_event_cb(lv_event_t* e)
{
    ...
    MainPage_Init(new_scr);   // 初始化 UserSettings 页面
