...
const PinInfo_TypeDef PIN_MAP[PIN_MAX] =
{
  ...
  /* PA */
  {GPIOA, TIM2,  ADC1, GPIO_PINS_0,  TMR_SELECT_CHANNEL_1, ADC_CHANNEL_0  }, /* PA0 / TIM2_CH1 / ADC1_IN0 */
  {GPIOA, TIM2,  ADC1, GPIO_PINS_1,  TMR_SELECT_CHANNEL_2, ADC_CHANNEL_1  }, /* PA1 / TIM2_CH2 / ADC1_IN1 */
  {GPIOA, TIM2,  ADC1, GPIO_PINS_2,  TMR_SELECT_CHANNEL_3, ADC_CHANNEL_2  }, /* PA2 / TIM2_CH3 / ADC1_IN2 */
  {GPIOA, TIM2,  ADC1, GPIO_PINS_3,  TMR_SELECT_CHANNEL_4, ADC_CHANNEL_3  }, /* PA3 / TIM2_CH4 / ADC1_IN3 */
  {GPIOA, NULL,  ADC1, GPIO_PINS_4,  0,                    ADC_CHANNEL_4  }, /* PA4 / ADC1_IN4 */
  {GPIOA, NULL,  ADC1, GPIO_PINS_5,  0,                    ADC_CHANNEL_5  }, /* PA5 / ADC1_IN5 */
  {GPIOA, TIM3,  ADC1, GPIO_PINS_6,  TMR_SELECT_CHANNEL_1, ADC_CHANNEL_6  }, /* PA6 / TIM3_CH1 / ADC1_IN6 */
  {GPIOA, TIM3,  ADC1, GPIO_PINS_7,  TMR_SELECT_CHANNEL_2, ADC_CHANNEL_7  }, /* PA7 / TIM3_CH2 / ADC1_IN7 */
  {GPIOA, TIM1,  NULL, GPIO_PINS_8,  TMR_SELECT_CHANNEL_1, ADC_CHANNEL_X  }, /* PA8 / TIM1_CH1 */
  {GPIOA, TIM1,  NULL, GPIO_PINS_9,  TMR_SELECT_CHANNEL_2, ADC_CHANNEL_X  }, /* PA9 / TIM1_CH2 */
  {GPIOA, TIM1,  NULL, GPIO_PINS_10, TMR_SELECT_CHANNEL_3, ADC_CHANNEL_X  }, /* PA10 / TIM1_CH3 */
  {GPIOA, TIM1,  NULL, GPIO_PINS_11, TMR_SELECT_CHANNEL_4, ADC_CHANNEL_X  }, /* PA11 / TIM1_CH4 */
  ...
  /* PB */
  {GPIOB, TIM3,  ADC1, GPIO_PINS_0,  TMR_SELECT_CHANNEL_3, ADC_CHANNEL_8  }, /* PB0 / TIM3_CH3 / ADC1_IN8 */
  {GPIOB, TIM3,  ADC1, GPIO_PINS_1,  TMR_SELECT_CHANNEL_4, ADC_CHANNEL_9  }, /* PB1 / TIM3_CH4 / ADC1_IN9 */
  ...
  {GPIOB, TIM4,  NULL, GPIO_PINS_6,  TMR_SELECT_CHANNEL_1, ADC_CHANNEL_X  }, /* PB6 / TIM4_CH1 */
  {GPIOB, TIM4,  NULL, GPIO_PINS_7,  TMR_SELECT_CHANNEL_2, ADC_CHANNEL_X  }, /* PB7 / TIM4_CH2 */
  {GPIOB, TIM4,  NULL, GPIO_PINS_8,  TMR_SELECT_CHANNEL_3, ADC_CHANNEL_X  }, /* PB8 / TIM4_CH3 */
  {GPIOB, TIM4,  NULL, GPIO_PINS_9,  TMR_SELECT_CHANNEL_4, ADC_CHANNEL_X  }, /* PB9 / TIM4_CH4 */
  ...
  {GPIOC, TMR8,  NULL, GPIO_PINS_6,  TMR_SELECT_CHANNEL_1, ADC_CHANNEL_X  }, /* PC6 / TMR8_CH1 */
  {GPIOC, TMR8,  NULL, GPIO_PINS_7,  TMR_SELECT_CHANNEL_2, ADC_CHANNEL_X  }, /* PC7 / TMR8_CH2 */
  {GPIOC, TMR8,  NULL, GPIO_PINS_8,  TMR_SELECT_CHANNEL_3, ADC_CHANNEL_X  }, /* PC8 / TMR8_CH3 */
  {GPIOC, TMR8,  NULL, GPIO_PINS_9,  TMR_SELECT_CHANNEL_4, ADC_CHANNEL_X  }, /* PC9 / TMR8_CH4 */
  ...
  {GPIOD, TIM4,  NULL, GPIO_PINS_12, TMR_SELECT_CHANNEL_1, ADC_CHANNEL_X  }, /* PD12 / TIM4_CH1 */
  {GPIOD, TIM4,  NULL, GPIO_PINS_13, TMR_SELECT_CHANNEL_2, ADC_CHANNEL_X  }, /* PD13 / TIM4_CH2 */
  {GPIOD, TIM4,  NULL, GPIO_PINS_14, TMR_SELECT_CHANNEL_3, ADC_CHANNEL_X  }, /* PD14 / TIM4_CH3 */
  {GPIOD, TIM4,  NULL, GPIO_PINS_15, TMR_SELECT_CHANNEL_4, ADC_CHANNEL_X  }, /* PD15 / TIM4_CH4 */
  ...
  {GPIOE, TIM1,  NULL, GPIO_PINS_9,  TMR_SELECT_CHANNEL_1, ADC_CHANNEL_X  }, /* PE9 / TIM1_CH1 */
  {GPIOE, NULL,  NULL, GPIO_PINS_10, 0,                    ADC_CHANNEL_X  }, /* PE10 */
  {GPIOE, TIM1,  NULL, GPIO_PINS_11, TMR_SELECT_CHANNEL_2, ADC_CHANNEL_X  }, /* PE11 / TIM1_CH2 */
  {GPIOE, NULL,  NULL, GPIO_PINS_12, 0,                    ADC_CHANNEL_X  }, /* PE12 */
  {GPIOE, TIM1,  NULL, GPIO_PINS_13, TMR_SELECT_CHANNEL_3, ADC_CHANNEL_X  }, /* PE13 / TIM1_CH3 */
  {GPIOE, TIM1,  NULL, GPIO_PINS_14, TMR_SELECT_CHANNEL_4, ADC_CHANNEL_X  }, /* PE14 / TIM1_CH4 */
